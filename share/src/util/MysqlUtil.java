	    ...
	    private void addConnection(){
		    ...
		    private void readConfig(){
		    	if(ShareConst.ispublic){
		            ...
		            this.url = "jdbc:mysql://localhost:3306/share?autoReconnect=true&useUnicode=true&characterEncoding=utf8";
		            this.poolSize =10;
		    	}else{
		    		this.driverClassName ="com.mysql.jdbc.Driver";
		            this.username ="focuspv";
		            this.password = "focuspv";
		            this.url = "jdbc:mysql://10.10.90.174:3306/share?autoReconnect=true&useUnicode=true&characterEncoding=utf8";
		            this.poolSize =10;
		    	}
